...
- The reason is written down rather than left implied. MW.1b has to be written by running it, there is no Windows machine a coding agent can reach, and MW.3 is a checklist only the owner can sign. Holding the Linux release behind those would price the release in owner hours rather than in work.
